...
class Home extends Component {
	...
	render() {
		return (
			<React.Fragment>
				<iframe className="center star-github" src="https://ghbtns.com/github-btn.html?user=vortex2099&repo=Music&type=star&count=true" frameborder="0" scrolling="0" width="170px" height="20px"></iframe>
				<a href="https://github.com/vortex2099/Music">
